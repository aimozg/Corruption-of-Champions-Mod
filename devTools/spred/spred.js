...
(function (monsters) {
    ...
    function listMonsters() {
        ...
        for (let id in monsters.lib) {
            ...
            j1.append($('<a>')
                ...
                .attr('role', 'tab')
                .click((e) => {
                showMonster(monsters.lib[e.target.getAttribute('href').substring(1)]);
                e.stopPropagation();
            }));
            j2.append($('<option>').val(id).html(name));
        }
    }
    monsters.listMonsters = listMonsters;
    function loadMod(data) {
        ...
        listMonsters();
        showMonster(monsters.lib[Object.keys(monsters.lib)[0]]);
    }
