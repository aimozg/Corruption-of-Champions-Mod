/*
** This file is part of Lua library from Adobe Crossbridge/samples/Example_Lua/lua-5.2.0/src/
** Modifications by aimozg:
** - Fixed bug with flash.getstring builtin
*/
