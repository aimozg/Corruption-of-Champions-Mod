...
//[GetBJ] - requires cock 108 area or less
		private function getABJFromAFoxGirl():void
		{
			...
			outputText((((player.balls > 0) || (player.vaginas.length > 0)) ? "  Trailing them across your sides, she " + ((player.balls > 0) ? "cups your [balls] in her hand, squeezing tightly" + ((player.vaginas.length > 0) ? " and " : "") : "") + ((player.vaginas.length > 0) ? "runs her index finger teasingly along your slit" : "" ) + "." : "" ));
...
//Discovery
		public function kitsuneShrine():void
		{
			...
			if (player.hasPerk(PerkLib.StarSphereMastery) && player.perkv1(PerkLib.StarSphereMastery) < 10 && player.gems >= 1000) addButton(3, "Offering", offeringToTaoth);
			...
			if (player.hasPerk(PerkLib.CorruptedNinetails) && player.inte >= 100 && player.cor >= 50 && flags[kFLAGS.AYANE_FOLLOWER] < 2) addButton(7, "Slave", AyaneSlave);
