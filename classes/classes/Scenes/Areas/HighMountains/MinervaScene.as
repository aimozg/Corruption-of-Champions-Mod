...
private function firstMinervaEncounter():void {
	...
	//If Sophie Bimbo=0:
	if(flags[kFLAGS.SOPHIE_BIMBO] == 0 && flags[kFLAGS.SOPHIE_DISABLED_FOREVER] == 0 && !SceneLib.sophieFollowerScene.sophieFollower()) outputText(" that matronly harpy, Sophie");
