...
public class LizanRogue extends Monster
	{
		...
		public function LizanRogue() 
		{
			...
			this.onPcRunAttempt = curry(combat.runSucceed,"As you retreat the lizan doesn't even attempt to stop you. When you look back to see if he's still there you find nothing but the empty bog around you.");
			checkMonster();
		}
