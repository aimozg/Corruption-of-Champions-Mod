...
public class HellHoundScene extends BaseContent
	{
		...
		private function get mod():GameMod {
			if (_mod == null) _mod = CoC.instance.findMod("hellhound");
			return _mod
		}
