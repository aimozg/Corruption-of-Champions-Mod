package classes.Scenes.Seasonal {
	...
	public class XmasElf extends BaseContent
	{
		...
		public function xmasBitchEncounter():void
		{
			...
			if (player.cor >= (90 + player.corruptionTolerance()) || flags[kFLAGS.JOJO_STATUS] >= 5 || player.hasStatusEffect(StatusEffects.Exgartuan) || getGame().amilyScene.isCorrupt() || flags[kFLAGS.SOPHIE_DISABLED_FOREVER] > 0 || flags[kFLAGS.SOPHIE_BIMBO] > 0 || flags[kFLAGS.NIAMH_STATUS] > 0)
			{
