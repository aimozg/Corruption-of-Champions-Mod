...
public class LethiceScenes extends BaseContent
	{
		...
		private function woofwoof():void
		{
			...
			if (flags[kFLAGS.FACTORY_SHUTDOWN] == 1) outputText("Your predecessor destroyed our welcoming facility. Otherwise I’m sure a certain imp would have revealed the truth to you long ago, before joining you with our breeding machines.\"</i>");
			else
			{
		...
		private function HowFuckedIsThePlayerOMeter():Number
		{
			...
			//Marae corrupt +50
			if (flags[kFLAGS.FACTORY_SHUTDOWN] == 2) levelOfFuckedness += 50;
		...
		private function purgeShit():void
		{
			...
			if (levelOfFuckedness <= 50)
			{
				...
				if (!flags[kFLAGS.FACTORY_SHUTDOWN] == 2) outputText(" Marae reclaimed the full network of her roots and single-handedly purged the last holdouts of corruption from the lands, choking it out of her world like weeds from a garden.");
			...
			else if (levelOfFuckedness <= 100)
			{
				...
				outputText("\n\n");
				if (!flags[kFLAGS.FACTORY_SHUTDOWN] == 2) outputText("Marae is a wonderful aid in your quest, always able to manifest in her newly purified roots and offer words of wisdom or encouragement. Her magical might is a rock you can lean upon when times are tough. You aren’t sure how long you could keep this up without her.");
				...
				if (!flags[kFLAGS.FACTORY_SHUTDOWN] == 2) outputText(" Those few pockets that escaped your armies could not escape Marae’s all-encompassing roots. Mareth is purified once more.");
