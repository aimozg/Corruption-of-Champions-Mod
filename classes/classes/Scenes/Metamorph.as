...
public function accessMetamorphMenu():void {
	clearOutput();
	outputText("Using some of ki to re-gain any animal bodyparts that your body remember in it genetic memory.\n\n");
...
private function accessSkinMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedFur) && player.skinType != Skin.FUR && player.ki >= 100) addButton(0, "Fur", metamorphFur);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFur) && player.skinType != Skin.FUR && player.ki < 100) addButtonDisabled(0, "Fur", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedScales) && player.skinType != Skin.SCALES && player.ki >= 100) addButton(1, "Scales", metamorphScales);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedScales) && player.skinType != Skin.SCALES && player.ki < 100) addButtonDisabled(1, "Scales", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedChitin) && !player.hasCoatOfType(Skin.CHITIN) && player.ki >= 100) addButton(3, "Chitin", metamorphChitin);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedChitin) && !player.hasCoatOfType(Skin.CHITIN) && player.ki < 100) addButtonDisabled(3, "Chitin", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(3, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDragonScales) && player.skinType != Skin.DRAGON_SCALES && player.ki >= 150) addButton(8, "D.Scales", metamorphDragonScales);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDragonScales) && player.skinType != Skin.DRAGON_SCALES && player.ki < 150) addButtonDisabled(8, "D.Scales", "You not have enough Ki for this metamorphosis.");
...
private function accessHairMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedHarpyHair) && player.hairType != Hair.FEATHER && player.ki >= 100) addButton(0, "Harpy", metamorphHarpyHair);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedHarpyHair) && player.hairType != Hair.FEATHER && player.ki < 100) addButtonDisabled(0, "Harpy", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedGorgonHair) && player.hairType != Hair.GORGON && player.ki >= 100) addButton(5, "Gorgon", metamorphGorgonHair);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedGorgonHair) && player.hairType != Hair.GORGON && player.ki < 100) addButtonDisabled(5, "Gorgon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfHair) && player.hairType != Hair.SILKEN && player.ki >= 100) addButton(9, "Elf", metamorphElfHair);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedElfHair) && player.hairType != Hair.SILKEN && player.ki < 100) addButtonDisabled(9, "Elf", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(9, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedRaijuHair) && player.hairType != Hair.STORM && player.ki >= 100) addButton(10, "Raiju", metamorphRaijuHair);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedRaijuHair) && player.hairType != Hair.STORM && player.ki < 100) addButtonDisabled(10, "Raiju", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(10, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessPage1FaceMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurFace) && player.faceType != Face.COW_MINOTAUR && player.ki >= 100) addButton(2, "Cow/Mino", metamorphCowMinotaurFace);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurFace) && player.faceType != Face.COW_MINOTAUR && player.ki < 100) addButtonDisabled(2, "Cow/Mino", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSharkTeeth) && player.faceType != Face.SHARK_TEETH && player.ki >= 100) addButton(3, "Shark", metamorphSharkTeeth);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSharkTeeth) && player.faceType != Face.SHARK_TEETH && player.ki < 100) addButtonDisabled(3, "Shark", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(3, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSnakeFangs) && player.faceType != Face.SNAKE_FANGS && player.ki >= 100) addButton(4, "Snake", metamorphSnakeFangs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSnakeFangs) && player.faceType != Face.SNAKE_FANGS && player.ki < 100) addButtonDisabled(4, "Snake", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(4, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedLizardFace) && player.faceType != Face.LIZARD && player.ki >= 100) addButton(7, "Lizard", metamorphLizardFace);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedLizardFace) && player.faceType != Face.LIZARD && player.ki < 100) addButtonDisabled(7, "Lizard", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSpiderFangs) && player.faceType != Face.SPIDER_FANGS && player.ki >= 100) addButton(10, "Spider", metamorphSpiderFangs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSpiderFangs) && player.faceType != Face.SPIDER_FANGS && player.ki < 100) addButtonDisabled(10, "Spider", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(10, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxFace) && player.faceType != Face.FOX && player.ki >= 100) addButton(11, "Fox", metamorphFaceFox);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxFace) && player.faceType != Face.FOX && player.ki < 100) addButtonDisabled(11, "Fox", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(11, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicFace) && player.faceType != Face.DRAGON && player.ki >= 100) addButton(12, "Dragon", metamorphDragonFace);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicFace) && player.faceType != Face.DRAGON && player.ki < 100) addButtonDisabled(12, "Dragon", "You not have enough Ki for this metamorphosis.");
...
private function accessTongueMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedSnakeTongue) && player.tongue.type != Tongue.SNAKE && player.ki >= 100) addButton(0, "Snake", metamorphSnakeTongue);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSnakeTongue) && player.tongue.type != Tongue.SNAKE && player.ki < 100) addButtonDisabled(0, "Snake", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDemonTonuge) && player.tongue.type != Tongue.DEMONIC && player.ki >= 100) addButton(1, "Demon", metamorphTonugeDemonic);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDemonTonuge) && player.tongue.type != Tongue.DEMONIC && player.ki < 100) addButtonDisabled(1, "Demon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicTongue) && player.tongue.type != Tongue.DRACONIC && player.ki >= 100) addButton(2, "Dragon", metamorphDragonTonuge);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicTongue) && player.tongue.type != Tongue.DRACONIC && player.ki < 100) addButtonDisabled(2, "Dragon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfTongue) && player.tongue.type != Tongue.ELF && player.ki >= 100) addButton(5, "Elf", metamorphElfTongue);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedElfTongue) && player.tongue.type != Tongue.ELF && player.ki < 100) addButtonDisabled(5, "Elf", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessEyesMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedSpiderFourEyes) && player.eyes.type != Eyes.FOUR_SPIDER_EYES && player.ki >= 100) addButton(0, "Spider", metamorphSpiderFourEyes);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSpiderFourEyes) && player.eyes.type != Eyes.FOUR_SPIDER_EYES && player.ki < 100) addButtonDisabled(0, "Spider", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxEyes) && player.eyes.type != Eyes.SLITS && player.ki >= 100) addButton(6, "Fox", metamorphEyesFox);
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxEyes) && player.eyes.type == Eyes.SLITS) addButtonDisabled(6, "Fox", "You already have fox eyes.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxEyes) && player.eyes.type != Eyes.SLITS && player.ki < 100) addButtonDisabled(6, "Fox", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(6, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedLizardEyes) && player.eyes.type != Eyes.REPTILIAN && player.ki >= 100) addButton(7, "Lizard", metamorphLizardEyes);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedLizardEyes) && player.eyes.type != Eyes.REPTILIAN && player.ki < 100) addButtonDisabled(7, "Lizard", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSnakeEyes) && player.eyes.type != Eyes.SNAKE && player.ki >= 100) addButton(8, "Snake", metamorphSnakeEyes);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSnakeEyes) && player.eyes.type != Eyes.SNAKE && player.ki < 100) addButtonDisabled(8, "Snake", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(8, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicEyes) && player.eyes.type != Eyes.DRAGON && player.ki >= 100) addButton(9, "Dragon", metamorphDragonEyes);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicEyes) && player.eyes.type != Eyes.DRAGON && player.ki < 100) addButtonDisabled(9, "Dragon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(9, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDevilEyes) && player.eyes.type != Eyes.DEVIL && player.ki >= 100) addButton(10, "Devil", metamorphDevilEyes);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDevilEyes) && player.eyes.type != Eyes.DEVIL && player.ki < 100) addButtonDisabled(10, "Devil", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(10, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniEyes) && player.eyes.type != Eyes.ONI && player.ki >= 100) addButton(11, "Oni", metamorphOniEyes);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniEyes) && player.eyes.type != Eyes.ONI && player.ki < 100) addButtonDisabled(11, "Oni", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(11, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfEyes) && player.eyes.type != Eyes.ELF && player.ki >= 100) addButton(12, "Elf", metamorphElfEyes);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedElfEyes) && player.eyes.type != Eyes.ELF && player.ki < 100) addButtonDisabled(12, "Elf", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(12, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedRaijuEyes) && player.eyes.type != Eyes.RAIJU && player.ki >= 100) addButton(13, "Raiju", metamorphRaijuEyes);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedRaijuEyes) && player.eyes.type != Eyes.RAIJU && player.ki < 100) addButtonDisabled(13, "Raiju", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(13, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessPage1EarsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedCowEars) && player.ears.type != Ears.COW && player.ki >= 100) addButton(2, "Cow", metamorphCowEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowEars) && player.ears.type != Ears.COW && player.ki < 100) addButtonDisabled(2, "Cow", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfinEars) && player.ears.type != Ears.ELFIN && player.ki >= 100) addButton(3, "Elfin", metamorphElfinEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedElfinEars) && player.ears.type != Ears.ELFIN && player.ki < 100) addButtonDisabled(3, "Elfin", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(3, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedLizardEars) && player.ears.type != Ears.LIZARD && player.ki >= 100) addButton(5, "Lizard", metamorphLizardEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedLizardEars) && player.ears.type != Ears.LIZARD && player.ki < 100) addButtonDisabled(5, "Lizard", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxEars) && player.ears.type != Ears.FOX && player.ki >= 100) addButton(8, "Fox", metamorphEarsFox);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxEars) && player.ears.type != Ears.FOX && player.ki < 100) addButtonDisabled(8, "Fox", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(8, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicEars) && player.ears.type != Ears.DRAGON && player.ki >= 100) addButton(9, "Dragon", metamorphDragonEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicEars) && player.ears.type != Ears.DRAGON && player.ki < 100) addButtonDisabled(9, "Dragon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(9, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessPage2EarsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedOrcaEars) && player.ears.type != Ears.ORCA && player.ki >= 100) addButton(7, "Orca", metamorphOrcaEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOrcaEars) && player.ears.type != Ears.ORCA && player.ki < 100) addButtonDisabled(7, "Orca", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSnakeEars) && player.ears.type != Ears.SNAKE && player.ki >= 100) addButton(8, "Snake", metamorphSnakeEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSnakeEars) && player.ears.type != Ears.SNAKE && player.ki < 100) addButtonDisabled(8, "Snake", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(8, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedGoatEars) && player.ears.type != Ears.GOAT && player.ki >= 100) addButton(9, "Goat", metamorphGoatEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedGoatEars) && player.ears.type != Ears.GOAT && player.ki < 100) addButtonDisabled(9, "Goat", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(9, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniEars) && player.ears.type != Ears.ONI && player.ki >= 100) addButton(10, "Oni", metamorphOniEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniEars) && player.ears.type != Ears.ONI && player.ki < 100) addButtonDisabled(10, "Oni", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(10, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfEars) && player.ears.type != Ears.ELVEN && player.ki >= 100) addButton(11, "Elf", metamorphElfEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedElfEars) && player.ears.type != Ears.ELVEN && player.ki < 100) addButtonDisabled(11, "Elf", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(11, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedRaijuEars) && player.ears.type != Ears.WEASEL && player.ki >= 100) addButton(12, "Raiju", metamorphRaijuEars);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedRaijuEars) && player.ears.type != Ears.WEASEL && player.ki < 100) addButtonDisabled(12, "Raiju", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(12, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessHornsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedDemonHorns) && player.horns.type != Horns.DEMON && player.ki >= 100) addButton(0, "Demon", metamorphHornsDemonic);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDemonHorns) && player.horns.type != Horns.DEMON && player.ki < 100) addButtonDisabled(0, "Demon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurHorns) && player.horns.type != Horns.COW_MINOTAUR && player.ki >= 100) addButton(1, "Cow/Mino", metamorphCowMinotaurHorns);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurHorns) && player.horns.type != Horns.COW_MINOTAUR && player.ki < 100) addButtonDisabled(1, "Cow/Mino", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicX2) && player.horns.type != Horns.DRACONIC_X2 && player.ki >= 100) addButton(2, "DraconicX2", metamorphHornsDraconicX2);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicX2) && player.horns.type != Horns.DRACONIC_X2 && player.ki < 100) addButtonDisabled(2, "DraconicX2", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicX4) && player.horns.type == Horns.DRACONIC_X2 && player.ki >= 200) addButton(3, "DraconicX4", metamorphHornsDraconicX4);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicX4) && player.horns.type == Horns.DRACONIC_X2 && player.ki < 200) addButtonDisabled(3, "DraconicX4", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedGoatHorns) && player.horns.type != Horns.GOAT && player.ki >= 100) addButton(5, "Goat", metamorphGoatHorns);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedGoatHorns) && player.horns.type != Horns.GOAT && player.ki < 100) addButtonDisabled(5, "Goat", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniSingleHorn) && player.horns.type != Horns.ONI && player.ki >= 100) addButton(11, "Oni", metamorphOniSingleHorn);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniSingleHorn) && player.horns.type != Horns.ONI && player.ki < 100) addButtonDisabled(11, "Oni", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(11, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniTwinHorns) && player.horns.type != Horns.ONI_X2 && player.ki >= 100) addButton(12, "OniX2", metamorphOniDualHorns);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniTwinHorns) && player.horns.type != Horns.ONI_X2 && player.ki < 100) addButtonDisabled(12, "OniX2", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(12, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessAntennaeMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisAntennae) && player.antennae.type != Antennae.MANTIS && player.ki >= 100) addButton(0, "Mantis", metamorphMantisAntennae);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisAntennae) && player.antennae.type != Antennae.MANTIS && player.ki < 100) addButtonDisabled(0, "Mantis", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedBeeAntennae) && player.antennae.type != Antennae.BEE && player.ki >= 100) addButton(1, "Bee", metamorphBeeAntennae);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedBeeAntennae) && player.antennae.type != Antennae.BEE && player.ki < 100) addButtonDisabled(1, "Bee", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessGillsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedFishGills) && player.gills.type != Gills.FISH && player.ki >= 100) addButton(1, "Fish", metamorphFishGills);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFishGills) && player.gills.type != Gills.FISH && player.ki < 100) addButtonDisabled(1, "Fish", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessPage1ArmsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedHarpyArms) && player.arms.type != Arms.HARPY && player.ki >= 100) addButton(0, "Harpy", metamorphHarpyArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedHarpyArms) && player.arms.type != Arms.HARPY && player.ki < 100) addButtonDisabled(0, "Harpy", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSpiderArms) && player.arms.type != Arms.SPIDER && player.ki >= 100) addButton(1, "Spider", metamorphSpiderArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSpiderArms) && player.arms.type != Arms.SPIDER && player.ki < 100) addButtonDisabled(1, "Spider", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisArms) && player.arms.type != Arms.MANTIS && player.ki >= 100) addButton(2, "Mantis", metamorphMantisArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisArms) && player.arms.type != Arms.MANTIS && player.ki < 100) addButtonDisabled(2, "Mantis", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedBeeArms) && player.arms.type != Arms.BEE && player.ki >= 100) addButton(3, "Bee", metamorphBeeArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedBeeArms) && player.arms.type != Arms.BEE && player.ki < 100) addButtonDisabled(3, "Bee", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(3, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSalamanderArms) && player.arms.type != Arms.SALAMANDER && player.ki >= 100) addButton(4, "Salamander", metamorphSalamanderArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSalamanderArms) && player.arms.type != Arms.SALAMANDER && player.ki < 100) addButtonDisabled(4, "Salamander", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(4, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedPhoenixArms) && player.arms.type != Arms.PHOENIX && player.ki >= 100) addButton(5, "Phoenix", metamorphPhoenixArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedPhoenixArms) && player.arms.type != Arms.PHOENIX && player.ki < 100) addButtonDisabled(5, "Phoenix", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSharkArms) && player.arms.type != Arms.SHARK && player.ki >= 100) addButton(7, "Shark", metamorphSharkArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSharkArms) && player.arms.type != Arms.SHARK && player.ki < 100) addButtonDisabled(7, "Shark", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxArms) && player.arms.type != Arms.FOX && player.ki >= 100) addButton(11, "Fox", metamorphArmsFox);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxArms) && player.arms.type != Arms.FOX && player.ki < 100) addButtonDisabled(11, "Fox", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(11, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedKitsuneArms) && player.arms.type != Arms.FOX && player.ki >= 100) addButton(12, "Kitsune", metamorphKitsuneArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedKitsuneArms) && player.arms.type != Arms.FOX && player.ki < 100) addButtonDisabled(12, "Kitsune", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(12, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedLizardArms) && player.arms.type != Arms.LIZARD && player.ki >= 100) addButton(13, "Lizard", metamorphLizardArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedLizardArms) && player.arms.type != Arms.LIZARD && player.ki < 100) addButtonDisabled(13, "Lizard", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(13, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessPage2ArmsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicArms) && player.arms.type != Arms.DRAGON && player.ki >= 100) addButton(0, "Dragon", metamorphDragonArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicArms) && player.arms.type != Arms.DRAGON && player.ki < 100) addButtonDisabled(0, "Dragon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOrcaArms) && player.arms.type != Arms.ORCA && player.ki >= 100) addButton(2, "Orca", metamorphOrcaArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOrcaArms) && player.arms.type != Arms.ORCA && player.ki < 100) addButtonDisabled(2, "Orca", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDevilArms) && player.arms.type != Arms.DEVIL && player.ki >= 100) addButton(4, "Devil", metamorphDevilArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDevilArms) && player.arms.type != Arms.DEVIL && player.ki < 100) addButtonDisabled(4, "Devil", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(4, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniArms) && player.arms.type != Arms.ONI && player.ki >= 100) addButton(5, "Oni", metamorphOniArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniArms) && player.arms.type != Arms.ONI && player.ki < 100) addButtonDisabled(5, "Oni", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfArms) && player.arms.type != Arms.ELF && player.ki >= 100) addButton(6, "Elf", metamorphElfArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedElfArms) && player.arms.type != Arms.ELF && player.ki < 100) addButtonDisabled(6, "Elf", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(6, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedRaijuArms) && player.arms.type != Arms.RAIJU && player.ki >= 100) addButton(7, "Raiju", metamorphRaijuArms);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedRaijuArms) && player.arms.type != Arms.RAIJU && player.ki < 100) addButtonDisabled(7, "Raiju", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
...
private function accessPage1TailMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedDemonTail) && player.tailType != Tail.DEMONIC && player.ki >= 100) addButton(2, "Demon", metamorphTailDemonic);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDemonTail) && player.tailType != Tail.DEMONIC && player.ki < 100) addButtonDisabled(2, "Demon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedCowTail) && player.tailType != Tail.COW && player.ki >= 100) addButton(3, "Cow", metamorphCowTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowTail) && player.tailType != Tail.COW && player.ki < 100) addButtonDisabled(3, "Cow", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(3, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSpiderTail) && player.tailType != Tail.SPIDER_ADBOMEN && player.ki >= 100) addButton(4, "Spider", metamorphSpiderTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSpiderTail) && player.tailType != Tail.SPIDER_ADBOMEN && player.ki < 100) addButtonDisabled(4, "Spider", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(4, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedBeeTail) && player.tailType != Tail.BEE_ABDOMEN && player.ki >= 100) addButton(5, "Bee", metamorphBeeTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedBeeTail) && player.tailType != Tail.BEE_ABDOMEN && player.ki < 100) addButtonDisabled(5, "Bee", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSharkTail) && player.tailType != Tail.SHARK && player.ki >= 100) addButton(6, "Shark", metamorphSharkTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSharkTail) && player.tailType != Tail.SHARK && player.ki < 100) addButtonDisabled(6, "Shark", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(6, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedLizardTail) && player.tailType != Tail.LIZARD && player.ki >= 100) addButton(8, "Lizard", metamorphLizardTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedLizardTail) && player.tailType != Tail.LIZARD && player.ki < 100) addButtonDisabled(8, "Lizard", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(8, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedHarpyTail) && player.tailType != Tail.HARPY && player.ki >= 100) addButton(10, "Harpy", metamorphHarpyTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedHarpyTail) && player.tailType != Tail.HARPY && player.ki < 100) addButtonDisabled(8, "Harpy", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(10, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail) && player.tailType != Tail.FOX && player.ki >= 100) addButton(13, "Fox", metamorphTailFox);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail) && player.tailType != Tail.FOX && player.ki < 100) addButtonDisabled(13, "Fox", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(13, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage2MetamorphMenu);
}
private function accessPage2TailMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail2nd) && player.tailType == Tail.FOX && player.tailCount == 1 && player.ki >= 200) addButton(0, "Fox 2nd", metamorphTailFox2nd);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail2nd) && player.tailType == Tail.FOX && player.tailCount == 1 && player.ki < 200) addButtonDisabled(0, "Fox 2nd", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail3rd) && player.tailType == Tail.FOX && player.tailCount == 2 && player.ki >= 300) addButton(1, "Fox 3rd", metamorphTailFox3rd);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail3rd) && player.tailType == Tail.FOX && player.tailCount == 2 && player.ki < 300) addButtonDisabled(1, "Fox 3rd", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail4th) && player.tailType == Tail.FOX && player.tailCount == 3 && player.ki >= 400) addButton(2, "Fox 4th", metamorphTailFox4th);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail4th) && player.tailType == Tail.FOX && player.tailCount == 3 && player.ki < 400) addButtonDisabled(2, "Fox 4th", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail5th) && player.tailType == Tail.FOX && player.tailCount == 4 && player.ki >= 500) addButton(3, "Fox 5th", metamorphTailFox5th);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail5th) && player.tailType == Tail.FOX && player.tailCount == 4 && player.ki < 500) addButtonDisabled(3, "Fox 5th", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail6th) && player.tailType == Tail.FOX && player.tailCount == 5 && player.ki >= 600) addButton(4, "Fox 6th", metamorphTailFox6th);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail6th) && player.tailType == Tail.FOX && player.tailCount == 5 && player.ki < 600) addButtonDisabled(4, "Fox 6th", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail7th) && player.tailType == Tail.FOX && player.tailCount == 6 && player.ki >= 700) addButton(5, "Fox 7th", metamorphTailFox7th);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail7th) && player.tailType == Tail.FOX && player.tailCount == 6 && player.ki < 700) addButtonDisabled(5, "Fox 7th", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail8th) && player.tailType == Tail.FOX && player.tailCount == 7 && player.ki >= 800) addButton(6, "Fox 8th", metamorphTailFox8th);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail8th) && player.tailType == Tail.FOX && player.tailCount == 7 && player.ki < 800) addButtonDisabled(6, "Fox 8th", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail9th) && player.tailType == Tail.FOX && player.tailCount == 8 && player.ki >= 900) addButton(7, "Fox 9th", metamorphTailFox9th);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxTail9th) && player.tailType == Tail.FOX && player.tailCount == 8 && player.ki < 900) addButtonDisabled(7, "Fox 9th", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicTail) && player.tailType != Tail.DRACONIC && player.ki >= 100) addButton(8, "Dragon", metamorphDragonTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicTail) && player.tailType != Tail.DRACONIC && player.ki < 100) addButtonDisabled(13, "Dragon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(8, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage2MetamorphMenu);
}
private function accessPage3TailMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedGoatTail) && player.tailType != Tail.GOAT && player.ki >= 100) addButton(1, "Goat", metamorphGoatTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedGoatTail) && player.tailType != Tail.GOAT && player.ki < 100) addButtonDisabled(1, "Goat", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSalamanderTail) && player.tailType != Tail.SALAMANDER && player.ki >= 100) addButton(5, "Salamander", metamorphSalamanderTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSalamanderTail) && player.tailType != Tail.SALAMANDER && player.ki < 100) addButtonDisabled(5, "Salamander", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisTail) && player.tailType != Tail.MANTIS_ABDOMEN && player.ki >= 100) addButton(7, "Mantis", metamorphMantisTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisTail) && player.tailType != Tail.MANTIS_ABDOMEN && player.ki < 100) addButtonDisabled(7, "Mantis", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOrcaTail) && player.tailType != Tail.ORCA && player.ki >= 100) addButton(10, "Orca", metamorphOrcaTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOrcaTail) && player.tailType != Tail.ORCA && player.ki < 100) addButtonDisabled(10, "Orca", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(10, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedRaijuTail) && player.tailType != Tail.RAIJU && player.ki >= 100) addButton(12, "Raiju", metamorphRaijuTail);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedRaijuTail) && player.tailType != Tail.RAIJU && player.ki < 100) addButtonDisabled(12, "Raiju", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(12, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage2MetamorphMenu);
}
private function accessPage1WingsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedBeeWingsSmall) && player.wings.type != Wings.BEE_LIKE_SMALL && player.ki >= 100) addButton(0, "Bee(S)", metamorphBeeWingsSmall);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedBeeWingsSmall) && player.wings.type != Wings.BEE_LIKE_SMALL && player.ki < 100) addButtonDisabled(0, "Bee(S)", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedBeeWingsLarge) && player.wings.type == Wings.BEE_LIKE_SMALL && player.ki >= 200) addButton(1, "Bee(L)", metamorphBeeWingsLarge);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedBeeWingsLarge) && player.wings.type != Wings.BEE_LIKE_LARGE && player.ki < 200) addButtonDisabled(1, "Bee(L)", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedDemonTinyBatWings) && player.wings.type != Wings.BAT_LIKE_TINY && player.ki >= 100) addButton(4, "Demon(S)", metamorphWingsDemonicTiny);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDemonTinyBatWings) && player.wings.type != Wings.BAT_LIKE_TINY && player.ki < 100) addButtonDisabled(4, "Demon(S)", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(4, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDemonLargeBatWings) && player.wings.type == Wings.BAT_LIKE_TINY && player.ki >= 200) addButton(5, "Demon(L)", metamorphWingsDemoncLarge);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDemonLargeBatWings) && player.wings.type != Wings.BAT_LIKE_LARGE && player.ki < 200) addButtonDisabled(5, "Demon(L)", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedHarpyWings) && player.wings.type != Wings.FEATHERED && player.ki >= 100) addButton(6, "Harpy", metamorphHarpyWings);
	else if (player.hasStatusEffect(StatusEffects.UnlockedHarpyWings) && player.wings.type == Wings.FEATHERED) addButtonDisabled(6, "Harpy", "You already have harpy wings.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedHarpyWings) && player.wings.type != Wings.FEATHERED && player.ki < 100) addButtonDisabled(6, "Harpy", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(6, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicWingsSmall) && player.wings.type != Wings.DRACONIC_SMALL && player.ki >= 100) addButton(7, "Dragon(S)", metamorphDragonWingsSmall);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicWingsSmall) && player.wings.type != Wings.DRACONIC_SMALL && player.ki < 100) addButtonDisabled(7, "Dragon(S)", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicWingsLarge) && player.wings.type == Wings.DRACONIC_SMALL && player.ki >= 200) addButton(8, "Dragon(L)", metamorphDragonWingsLarge);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicWingsLarge) && player.wings.type != Wings.DRACONIC_LARGE && player.ki < 200) addButtonDisabled(8, "Dragon(L)", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedDemonLargeBatWings2) && player.wings.type == Wings.BAT_LIKE_LARGE && player.ki >= 300) addButton(10, "Demon(L2)", metamorphWingsDemonicLarge2);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDemonLargeBatWings2) && player.wings.type != Wings.BAT_LIKE_LARGE_2 && player.ki < 300) addButtonDisabled(10, "Demon(L2)", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicWingsHuge) && player.wings.type == Wings.DRACONIC_LARGE && player.ki >= 300) addButton(11, "Dragon(H)", metamorphDragonWingsHuge);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicWingsHuge) && player.wings.type != Wings.DRACONIC_HUGE && player.ki < 300) addButtonDisabled(11, "Dragon(H)", "You not have enough Ki for this metamorphosis.");
...
private function accessPage2WingsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsSmall) && player.wings.type != Wings.MANTIS_LIKE_SMALL && player.ki >= 100) addButton(0, "Mantis(S)", metamorphMantisWingsSmall);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsSmall) && player.wings.type != Wings.MANTIS_LIKE_SMALL && player.ki < 100) addButtonDisabled(0, "Mantis(S)", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsLarge) && player.wings.type == Wings.MANTIS_LIKE_SMALL && player.ki >= 200) addButton(1, "Mantis(L)", metamorphMantisWingsLarge);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsLarge) && player.wings.type != Wings.MANTIS_LIKE_LARGE && player.ki < 200) addButtonDisabled(1, "Mantis(L)", "You not have enough Ki for this metamorphosis.");
...
private function accessPage1LegsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedHoofedLegs) && player.lowerBody != LowerBody.HOOFED && player.ki >= 100) addButton(0, "Hoofed", metamorphHoofedLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedHoofedLegs) && player.lowerBody != LowerBody.HOOFED && player.ki < 100) addButtonDisabled(0, "Hoofed", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSnakeLowerBody) && player.lowerBody != LowerBody.NAGA && player.ki >= 100) addButton(2, "Snake", metamorphSnakeLowerBody);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSnakeLowerBody) && player.lowerBody != LowerBody.NAGA && player.ki < 100) addButtonDisabled(2, "Snake", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDemonHighHeels) && player.lowerBody != LowerBody.DEMONIC_HIGH_HEELS && (player.gender == 2 || player.gender == 3) && player.ki >= 100) addButton(3, "Demon(F)", metamorphLegsDemonicHighHeels);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDemonHighHeels) && player.lowerBody != LowerBody.DEMONIC_HIGH_HEELS && (player.gender == 2 || player.gender == 3) && player.ki < 100) addButtonDisabled(3, "Demon(F)", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(3, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDemonClawedLegs) && player.lowerBody != LowerBody.DEMONIC_CLAWS && player.gender != 2 && player.ki >= 100) addButton(4, "Demon(M)", metamorphLegsDemonicClaws);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDemonClawedLegs) && player.lowerBody != LowerBody.DEMONIC_CLAWS && player.gender != 2 && player.ki < 100) addButtonDisabled(4, "Demon(M)", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(4, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedBeeLegs) && player.lowerBody != LowerBody.BEE && player.ki >= 100) addButton(5, "Bee", metamorphBeeLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedBeeLegs) && player.lowerBody != LowerBody.BEE && player.ki < 100) addButtonDisabled(5, "Bee", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedLizardLegs) && player.lowerBody != LowerBody.LIZARD && player.ki >= 100) addButton(8, "Lizard", metamorphLizardLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedLizardLegs) && player.lowerBody != LowerBody.LIZARD && player.ki < 100) addButtonDisabled(8, "Lizard", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(8, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedHarpyLegs) && player.lowerBody != LowerBody.HARPY && player.ki >= 100) addButton(10, "Harpy", metamorphHarpyLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedHarpyLegs) && player.lowerBody != LowerBody.HARPY && player.ki < 100) addButtonDisabled(10, "Harpy", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(10, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSpiderLegs) && player.lowerBody != LowerBody.CHITINOUS_SPIDER_LEGS && player.ki >= 100) addButton(13, "Spider", metamorphSpiderLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSpiderLegs) && player.lowerBody != LowerBody.CHITINOUS_SPIDER_LEGS && player.ki < 100) addButtonDisabled(13, "Spider", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(13, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage2MetamorphMenu);
}
private function accessPage2LegsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedDriderLegs) && player.lowerBody == LowerBody.CHITINOUS_SPIDER_LEGS && player.tailType == Tail.SPIDER_ADBOMEN && player.ki >= 300) addButton(0, "Drider", metamorphDriderLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDriderLegs) && player.lowerBody == LowerBody.CHITINOUS_SPIDER_LEGS && player.tailType == Tail.SPIDER_ADBOMEN && player.ki < 300) addButtonDisabled(0, "Drider", "You not have enough Ki for this metamorphosis.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedFoxLowerBody) && player.lowerBody != LowerBody.FOX && player.ki >= 100) addButton(1, "Fox", metamorphLowerBodyFox);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedFoxLowerBody) && player.lowerBody != LowerBody.FOX && player.ki < 100) addButtonDisabled(1, "Fox", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedDraconicLegs) && player.lowerBody != LowerBody.DRAGON && player.ki >= 100) addButton(2, "Dragon", metamorphDragonLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicLegs) && player.lowerBody != LowerBody.DRAGON && player.ki < 100) addButtonDisabled(2, "Dragon", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedClovenHoofedLegs) && player.lowerBody != LowerBody.CLOVEN_HOOFED && player.ki >= 100) addButton(5, "ClovenHoofed", metamorphClovenHoofedLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedClovenHoofedLegs) && player.lowerBody != LowerBody.CLOVEN_HOOFED && player.ki < 100) addButtonDisabled(5, "ClovenHoofed", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSalamanderLegs) && player.lowerBody != LowerBody.SALAMANDER && player.ki >= 100) addButton(7, "Salamander", metamorphSalamanderLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSalamanderLegs) && player.lowerBody != LowerBody.SALAMANDER && player.ki < 100) addButtonDisabled(7, "Salamander", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisLegs) && player.lowerBody != LowerBody.MANTIS && player.ki >= 100) addButton(9, "Mantis", metamorphMantisLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisLegs) && player.lowerBody != LowerBody.MANTIS && player.ki < 100) addButtonDisabled(9, "Mantis", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(9, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSharkLegs) && player.lowerBody != LowerBody.SHARK && player.ki >= 100) addButton(11, "Shark", metamorphSharkLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSharkLegs) && player.lowerBody != LowerBody.SHARK && player.ki < 100) addButtonDisabled(11, "Shark", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(11, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage2MetamorphMenu);
}
private function accessPage3LegsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedOrcaLegs) && player.lowerBody != LowerBody.ORCA && player.ki >= 100) addButton(4, "Orca", metamorphOrcaLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOrcaLegs) && player.lowerBody != LowerBody.ORCA && player.ki < 100) addButtonDisabled(4, "Orca", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(4, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniLegs) && player.lowerBody != LowerBody.ONI && player.ki >= 100) addButton(6, "Oni", metamorphOniLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniLegs) && player.lowerBody != LowerBody.ONI && player.ki < 100) addButtonDisabled(6, "Oni", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(6, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfLegs) && player.lowerBody != LowerBody.ELF && player.ki >= 100) addButton(7, "Elf", metamorphElfLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedElfLegs) && player.lowerBody != LowerBody.ELF && player.ki < 100) addButtonDisabled(7, "Elf", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedRaijuLegs) && player.lowerBody != LowerBody.RAIJU && player.ki >= 100) addButton(8, "Raiju", metamorphRaijuLegs);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedRaijuLegs) && player.lowerBody != LowerBody.RAIJU && player.ki < 100) addButtonDisabled(8, "Raiju", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(8, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage2MetamorphMenu);
}
...
private function accessRearBodyMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedSharkFin) && player.rearBody.type != RearBody.SHARK_FIN && player.ki >= 100) addButton(5, "Shark", metamorphSharkFin);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSharkFin) && player.rearBody.type != RearBody.SHARK_FIN && player.ki < 100) addButtonDisabled(5, "Shark", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOrcaBlowhole) && player.rearBody.type != RearBody.ORCA_BLOWHOLE && player.ki >= 100) addButton(6, "Orca", metamorphOrcaBlowhole);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedOrcaBlowhole) && player.rearBody.type != RearBody.ORCA_BLOWHOLE && player.ki < 100) addButtonDisabled(6, "Shark", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(6, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedRaijuMane) && player.rearBody.type != RearBody.RAIJU_MANE && player.ki >= 100) addButton(7, "Raiju", metamorphRaijuMane);
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedRaijuMane) && player.rearBody.type != RearBody.RAIJU_MANE && player.ki < 100) addButtonDisabled(7, "Raiju", "You not have enough Ki for this metamorphosis.");
	else addButtonDisabled(6, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage2MetamorphMenu);
}/*
private function accessHairMenu():void {
...
private function metamorphHoofedLegs():void {
	...
	if (player.lowerBody == LowerBody.CANINE) outputText("\n\nYou stagger as your paws change, curling up into painful angry lumps of flesh.  They get tighter and tighter, harder and harder, until at last they solidify into hooves!");
...
private function metamorphLowerBodyFox():void {
	...
	else if (player.lowerBody == LowerBody.HOOFED || player.lowerBody == LowerBody.CANINE || player.lowerBody == LowerBody.CAT || player.lowerBody == LowerBody.BUNNY || player.lowerBody == LowerBody.KANGAROO) {
