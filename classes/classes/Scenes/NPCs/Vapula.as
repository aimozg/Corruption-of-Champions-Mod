...
//Vapula-Amily threesome
		private function vapulaAndAmilyThreesome():void
		{
			...
			//[if not defurred]
			if (amilyScene.isFurry()) outputText(" and her fur starts shrinking, letting her rosy skin shine below");
