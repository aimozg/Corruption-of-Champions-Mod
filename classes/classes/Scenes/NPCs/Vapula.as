...
public class Vapula extends NPCAwareContent implements TimeAwareInterface
	{
		...
		public function timeChange():Boolean
		{
			...
			if (vapulaSlave() && player.hasKeyItem("Demonic Strap-On") < 0 && player.gender == 2 && flags[kFLAGS.FOLLOWER_AT_FARM_VAPULA] == 0 && flags[kFLAGS.IN_INGNAM] == 0) {
		...
		public function timeChangeLarge():Boolean {
			if (flags[kFLAGS.IN_INGNAM] > 0) return false;
