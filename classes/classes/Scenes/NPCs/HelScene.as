...
public class HelScene extends NPCAwareContent implements TimeAwareInterface {
		...
		public function timeChange():Boolean
		{
			...
			if (model.time.hours == 3 && followerHel() && flags[kFLAGS.SLEEP_WITH] == "Helia" && rand(10) == 0 && flags[kFLAGS.IN_INGNAM] == 0) {
		...
		public function timeChangeLarge():Boolean {
			...
			if (model.time.hours == 8 && helFollower.followerHel() && flags[kFLAGS.HEL_NTR_TRACKER] == 1 && flags[kFLAGS.IN_INGNAM] == 0) {
			...
			if (flags[kFLAGS.HEL_FOLLOWER_LEVEL] == 1 && flags[kFLAGS.HEL_HARPY_QUEEN_DEFEATED] > 0 && helFollower.helAffection() >= 100 &&
				flags[kFLAGS.HELIA_FOLLOWER_DISABLED] == 0 && model.time.hours == 2 && flags[kFLAGS.IN_INGNAM] == 0) {
				helFollower.heliaFollowerIntro();
				return true;   
			}
			if (flags[kFLAGS.HEL_FOLLOWER_LEVEL] == -1 && model.time.hours == 6 && flags[kFLAGS.IN_INGNAM] == 0) {
            ...
            if (checkedHeliaIsabellaThreesome++ == 0 && flags[kFLAGS.HEL_FUCKBUDDY] == 1 && SceneLib.isabellaFollowerScene.isabellaFollower() && model.time.hours == 2 && model.time.days % 11 == 0 && flags[kFLAGS.FOLLOWER_AT_FARM_ISABELLA] == 0 && flags[kFLAGS.IN_INGNAM] == 0) {
...
internal function helTailPegging(loss:Boolean = false):void {
	...
	outputText("Eventually, you can take no more, and feel your climax coming on.  The salamander, sensing this from the fashion you're wringing her tail, gives your " + buttDescript() + " a hard slap and slams in as far as it can go.  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt");
	if(player.gender > 0) {
...
private function receiveCorruptRimjobsFromHel():void {
	...
	outputText("Firmly within your depths, she plants her smooth, scaled hands on your " + buttDescript() + " and starts to flick her tongue as fast as she can, withdrawing and ramming it back into your ass.  You gasp and moan like a whore");
