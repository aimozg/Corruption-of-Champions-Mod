...
/**
	...
	public class Sophie extends Harpy
	{
		...
		private function sophieKissAttack():void {
			...
			if(player.hasPerk(PerkLib.Misdirection) && rand(100) < 10 && player.armorName == "red, high-society bodysuit") {
		...
		private function sophieHarpyBoatsPC():void {
			...
			if(player.hasPerk(PerkLib.Misdirection) && rand(100) < 40 && player.armorName == "red, high-society bodysuit") {
				outputText("Using Raphael's teachings and the movement afforded by your bodysuit, you anticipate and sidestep " + a + short + "'s attack.\n");
				return;
			}
			//Determine if cat'ed
		...
		private function talonsSophie():void {
			...
			if(player.hasPerk(PerkLib.Misdirection) && rand(100) < 30 && player.armorName == "red, high-society bodysuit") {
				outputText("Using Raphael's teachings and the movement afforded by your bodysuit, you anticipate and sidestep " + a + short + "'s attack.\n");
				return;
			}
			//Determine if cat'ed
