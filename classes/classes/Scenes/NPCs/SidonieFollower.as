		...
		public function commingToCamp():void {
			...
			if (camp.companionsCount() >= 2) {
				...
				if (sophieFollower() && flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0) {
					...
					if(flags[kFLAGS.SOPHIE_BIMBO] > 0) outputText("\"<i>That blondie ditz is really annoying, you know</i>\" the horse-girl says, pointing at you bimbofied harpy, \"<i>I was still unpacking my things and she jumped from nowhere asking if she could suck my dick. Anyways, I guess that she is special to you, so I’ll do my best to be polite with her.</i>\"\n\n");
				}
