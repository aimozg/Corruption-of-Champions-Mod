...
import classes.Transformations.Lib.ArmsSpiderTf;
import classes.Transformations.Lib.EyeColorTf;
import classes.Transformations.Lib.HairColorTf;
import classes.Transformations.Lib.LegsSpiderTf;
...
public class TransformationLib extends MutationsHelper {
	...
	public const LegsSpider:Transformation = new LegsSpiderTf("black");
	public const LegsAtlach:Transformation = new LegsSpiderTf("midnight purple");
	 ...
	 */
	public const ArmsSpider:Transformation = new ArmsSpiderTf("black");

	public const ArmsAtlach:Transformation = new ArmsSpiderTf("midnight purple");
	...
	public const BreastsGrowUpToDD:Transformation = new SimpleTransformation("Grow breasts up to DD",
			...
			function (doOutput:Boolean, variant:String):void {
				...
				if (doOutput) {
					if (variant == 'consumable') {
						outputText("After eating it, your chest");
					} else {
						outputText("Your chest")
					}
					outputText(" aches and tingles, and your hands reach up to scratch at it unthinkingly.  Just as you start to scratch at your " + breastDescript(row) + ", your chest pushes out in slight but sudden growth.");
				}
	...
	public const List_AtlachNacha: /*Transformation*/ Array = [
		...
		SkinChitin,
		TieredSpiderFace,
		new HairColorTf(["midnight purple"]),
