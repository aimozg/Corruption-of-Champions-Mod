...
//25 za 1 ptk robes, 20 dla light, 40 dla medium i 60 dla heavy, z perkiem/dod. efektem podwaja koszt za każdy
		...
		public const BIMBOSK:Armor = new Armor("BimboSk", "BimboSk", "bimbo skirt", "a skirt that looks like it belongs on a bimbo", 1, 40, "A tight, cleavage-inducing halter top and an extremely short miniskirt.  The sexual allure of this item is undoubtable.", Armor.LIGHT, false, false, PerkLib.SluttySeduction, 10, 0, 0, 0, "Your delightfully slutty yet upbeat garb helps you seduce your foes!");
		public const BKIMONO:Armor = new Armor("B.Kimono", "B.Kimono", "blue kimono", "a blue kimono", 1, 200, "This lovely blue kimono is adorned with a floral pattern. It will likely increase your spiritual power as a kitsune.", Armor.LIGHT, false, true, PerkLib.WizardsAndDaoistsEndurance, 20, 20, 0, 0);
		public const BONSTRP:Armor = new Armor("BonStrp", "BonStrp", "barely-decent bondage straps", "a set of bondage straps", 0, 40, "These leather straps and well-placed hooks are actually designed in such a way as to be worn as clothing.  While they technically would cover your naughty bits, virtually every other inch of your body would be exposed.", Armor.LIGHT, false, false, PerkLib.SluttySeduction, 10, 0, 0, 0, "Your fetishy bondage outfit allows you access to an improved form of 'Tease'.");
		public const C_CLOTH:Armor = new Armor("C.Cloth", "C.Cloth", "comfortable clothes", "a set of comfortable clothes", 0, 1, "These loose fitting and comfortable clothes allow you to move freely while protecting you from the elements.", "Light", true);
		public const CHBIKNI:Armor = new Armor("ChBikni", "Chn Bikini", "revealing chainmail bikini", "a chainmail bikini", 2, 80, "A revealing chainmail bikini that barely covers anything.  The bottom half is little more than a triangle of metal and a leather thong.", Armor.LIGHT, false, false, PerkLib.SluttySeduction, 5, 0, 0, 0, "Your revealing chain bikini allows you access to 'Seduce', an improved form of 'Tease'.");
		...
		public const DSCLROB:Armor = new Armor("DSclRob", "D.Scale Robes", "dragonscale robes", "a dragonscale robes", 10, 500, "This robe is expertly made from dragon scales. It offers high protection while being lightweight and should be comfortable to wear all day.", Armor.LIGHT, false, true, PerkLib.WizardsEndurance, 20, 0, 0, 0);
		public const EHGARB_:Armor = new Armor("EH.Garb", "E.Heretic‘s Garb", "Ebonweave Heretic‘s Garb", "an Ebonweave Heretic‘s Garb", 20, 1600, "This outfit is ebonweave, created using refined ebonbloom petals. The outfit consists of arrowproof clothes, covered by a mesh breastplate and leatherlike duster inscribed with glyphs of magic and warding.  A trilby adorned with a moon pin completes the look.", Armor.LIGHT, true, true, PerkLib.WizardsAndDaoistsEndurance, 20, 20, 0, 0, "");
		public const EWJACK_:Armor = new Armor("EWJack", "E.W. Jacket", "ebonweave jacket", "an ebonweave jacket", 24, 960, "This outfit is ebonweave, created using refined ebonbloom petals. The outfit consists of a leatherlike jacket, a mesh breastplate and a set of arrowproof clothing. Between them all, the outfit provide layers of protection rivaling heavier, more traditional armor.", Armor.LIGHT, false, true, PerkLib.WizardsEndurance, 15, 0, 0, 0);
		public const EWPLTMA:Armor = new Armor("EWPltMa", "E.W. Platemail", "ebonweave platemail", "an ebonweave platemail", 36, 4320, "The armor is ebonweave, created using refined ebonbloom petals. The armor consists of two layers, an outer layer of ebonweave playing, and an inner layer of arrowproof ebonweave cloth.", Armor.HEAVY, false, true, PerkLib.WizardsEndurance, 15, 0, 0, 0);
		public const EWROBE_:Armor = new Armor("EWRobe", "E.W. Robe", "ebonweave robe", "an ebonweave robe", 12, 600, "This robe is ebonweave, created using refined ebonbloom petals. This robe is as comfortable as cloth yet more protective than chainmail. The cloth has a mystic aura, helpful when working magic.", Armor.LIGHT, false, true, PerkLib.WizardsEndurance, 30, 0, 0, 0);
		...
		public const H_GARB_:Armor = new Armor("H. Garb", "Heretic‘s Garb", "Heretic‘s Garb", "an Heretic‘s Garb", 6, 480, "Weathered traveling clothes, covered by a duster.  Wards and arcane glyphs inscribed in the duster facilitates magic while providing significant defense.  A feather tipped trilby completes the look.", Armor.LIGHT, true, true, PerkLib.WizardsAndDaoistsEndurance, 10, 10);
		public const I_CORST:Armor = new InquisitorsCorset();
		public const I_ROBES:Armor = new InquisitorsRobes();
		public const INDECST:Armor = new Armor("IndecSt", "Indec StAr", "practically indecent steel armor", "a suit of practically indecent steel armor", 5, 400, "This suit of steel 'armor' has two round disks that barely cover the nipples, a tight chainmail bikini, and circular butt-plates.", Armor.MEDIUM, false, true, PerkLib.SluttySeduction, 6, 0, 0, 0, "Your incredibly revealing steel armor allows you access to 'Seduce', an improved form of 'Tease'.");
		public const INDEDSR:Armor = new Armor("IndeDSR", "Indec D.Scale Robe", "indecent dragonscale robe", "an indecent dragonscale robe", 4, 400, "More of a longcoat than a robe, this outfit is crafted from dragon scales. Discrete straps centered around the belt keep the front perpetually open, displaying your groin and any cleavage you might have. The dragonscale is treated to be durable yet remain comfortable.", Armor.LIGHT, false, true, PerkLib.WizardsEnduranceAndSluttySeduction, 15, 5, 0, 0, "Your indecent dragonscale robe allows you access to 'Seduce', an improved form of 'Tease'.");
		public const INDEEWR:Armor = new Armor("IndeEWR", "Indec. E.W. Robe", "indecent ebonweave robe", "an indecent ebonweave robe", 6, 600, "More of a longcoat than a robe, this outfit is crafted from refined ebonbloom petals. Discrete straps centered around the belt keep the front perpetually open, displaying your groin and any cleavage you might have. The cloth has a mystic aura, helpful when working magic.", Armor.LIGHT, false, true, PerkLib.WizardsEnduranceAndSluttySeduction, 20, 5, 0, 0, "Your indecent ebonweave robe allows you access to 'Seduce', an improved form of 'Tease'.");
		public const INDESSR:Armor = new Armor("IndeSSR", "Indec S.S. Robe", "indecent spider silk robe", "an indecent spider silk robe", 2, 200, "More of a longcoat than a robe, this outfit is crafted from alchemically treated spider silk. Discrete straps centered around the belt keep the front perpetually open, displaying your groin and any cleavage you might have.", Armor.LIGHT, false, true, PerkLib.WizardsEnduranceAndSluttySeduction, 15, 5, 0, 0, "Your indecent spider silk robe allows you access to 'Seduce', an improved form of 'Tease'.");
		...
		public const NURSECL:Armor = new Armor("NurseCl", "NurseCl", "skimpy nurse's outfit", "a nurse's outfit", 0, 100, "This borderline obscene nurse's outfit would barely cover your hips and crotch.  The midriff is totally exposed, and the white top leaves plenty of room for cleavage.  A tiny white hat tops off the whole ensemble.  It would grant a small regeneration to your HP.", Armor.LIGHT, false, true, PerkLib.SluttySeduction, 8, 0, 0, 0, "Your fetishy nurse outfit allows you access to an improved form of 'Tease'.");
		public const OVERALL:Armor = new Armor("Overall", "Overalls", "white shirt and overalls", "a white shirt and overalls", 0, 25, "A simple white shirt and overalls.", Armor.LIGHT, true);
		public const PKIMONO:Armor = new Armor("P.Kimono", "P.Kimono", "purple kimono", "a purple kimono", 1, 200, "This lovely purple kimono is adorned with a floral pattern. It will likely increase your spiritual power as a kitsune.", Armor.LIGHT, false, true, PerkLib.WizardsAndDaoistsEndurance, 20, 20, 0, 0);
		public const R_BDYST:Armor = new Armor("R.BdySt","R.BdySt","red, high-society bodysuit","a red bodysuit for high society",1,50,"A high society bodysuit. It is as easy to mistake it for ballroom apparel as it is for boudoir lingerie. The thin transparent fabric is so light and airy that it makes avoiding blows a second nature.",Armor.LIGHT, true, false);
		public const RBBRCLT:Armor = new Armor("RbbrClt", "Rbbr Fetish", "rubber fetish clothes", "a set of revealing rubber fetish clothes", 3, 150, "A revealing set of fetish-wear.  Upgrades your tease attack with the \"Slutty Seduction\" perk.", Armor.LIGHT, true, false, PerkLib.SluttySeduction, 8, 0, 0, 0, "Your fetishy rubberwear allows you access to 'Seduce', an improved form of 'Tease'.");
		public const RKIMONO:Armor = new Armor("R.Kimono", "R.Kimono", "red kimono", "a red kimono", 1, 200, "This lovely red kimono is adorned with a floral pattern. It will likely increase your spiritual power as a kitsune.", Armor.LIGHT, false, true, PerkLib.WizardsAndDaoistsEndurance, 20, 20, 0, 0);
		...
		public const SS_ROBE:Armor = new Armor("SS.Robe", "SS.Robes", "spider-silk robes", "a spider-silk robes", 6, 300, "This robe looks incredibly comfortable.  It's made from alchemically enhanced spider-silk, and embroidered with what looks like magical glyphs around the sleeves and hood.", Armor.LIGHT, false, true, PerkLib.WizardsEndurance, 30, 0, 0, 0);
		...
		public const W_ROBES:Armor = new Armor("W.Robes", "W.Robes", "wizard's robes", "a wizard's robes", 1, 50, "These robes appear to have once belonged to a female wizard.  They're long with a slit up the side and full billowing sleeves.  The top is surprisingly low cut.  Somehow you know wearing it would aid your spellcasting.", Armor.LIGHT, false, true, PerkLib.WizardsEndurance, 25, 0, 0, 0);
		public const WKIMONO:Armor = new Armor("W.Kimono", "W.Kimono", "white kimono", "a white kimono", 1, 200, "This lovely white kimono is adorned with a floral pattern. It will likely increase your spiritual power as a kitsune.", Armor.LIGHT, false, true, PerkLib.WizardsAndDaoistsEndurance, 20, 20, 0, 0);
