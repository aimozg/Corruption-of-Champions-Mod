package classes {
	...
	public class MainMenu extends BaseContent {
		...
		private function configureMainMenu():void{
			...
			var background:BitmapDataSprite = new BitmapDataSprite({
				bitmapClass: MainView.Background0,
				width      : MainView.SCREEN_W,
				height     : MainView.SCREEN_H,
				fillColor  : 0,
				repeat     : true
			...
			revampLogo.y = Math.floor(MainView.SCREEN_H / 2) - 30;
			revampLogo.selectable = false;
			revampLogo.embedFonts = true;
			revampLogo.autoSize = TextFieldAutoSize.CENTER;
			revampLogo.defaultTextFormat = new TextFormat(CoCButton.ButtonLabelFontName, 35, mainViewManager.isDarkText() ? 0xc0c0c0 : 0, null, null, null, null, null, "center");
			revampLogo.htmlText = "Endless Journey";
			revampLogo.x = (MainView.SCREEN_W / 2) - revampLogo.width / 2;
			...
			for (var i:int = 0; i < mainMenuButtons.length; i++) {
				...
				if (i == 0) button.disableIf(player == null, "Please start a new game or load an existing save file.");
			}
		...
		public function startupScreenBody():void {
			...
			outputText("\n\tTulvir, Ashi, SoS, Prisoner416, Zeikfried, et al");
			...
			outputText("\n\n<b>Game Mod by:</b> Liadri"); //Mod Creator
			//Github for Original
			...
			//Github for Mod
			outputText("\n\n<b><u>Mod Github</u></b>");
			outputText("\n<b>Source Code:</b> <u><a href='https://github.com/Liadri/Corruption-of-Champions'>https://github.com/Liadri/Corruption-of-Champions</a></u>");
			//outputText("\n<b>Bug Tracker:</b> <u><a href='https://github.com/herp-a-derp/Corruption-of-Champions/issues'>https://github.com/herp-a-derp/Corruption-of-Champions/issues</a></u>");
			//Disclaimer
			outputText("\n\n<b><u>DISCLAIMER</u></b>");
...
//------------
		public function creditsScreen():void {
			...
			outputText("<ul>");
			outputText("<li> Ormael (Xianxia Mod Creator, base mod for this mod)</li>");
			outputText("<li> Kitteh6660 (Revamp Mod Creator, base mod for Xianxia)</li>");
			outputText("</ul>");
